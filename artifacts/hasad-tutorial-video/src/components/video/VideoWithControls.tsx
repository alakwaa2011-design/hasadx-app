  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'تكرار المشهد الحالي: مُفعَّل' : 'تكرار المشهد الحالي: معطّل'}
        aria-label={locked ? 'تكرار المشهد الحالي: مُفعَّل' : 'تكرار المشهد الحالي: معطّل'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={collapsed ? 'إظهار شريط التحكم' : 'إخفاء شريط التحكم'}
        aria-label={collapsed ? 'إظهار شريط التحكم' : 'إخفاء شريط التحكم'}
  ...
  if (!isIframed)
    return (
      <div className="w-full h-screen bg-black flex items-center justify-center">
        <div className="relative w-full max-h-screen aspect-video bg-black overflow-hidden">
          <VideoTemplate />
        </div>
      </div>
    );
