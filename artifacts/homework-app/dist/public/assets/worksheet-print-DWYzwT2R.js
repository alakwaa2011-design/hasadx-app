import{j as t,a as b,t as K,L as Le,a5 as qe,cw as ue,ev as Fe,by as Se,cq as Ee}from"./vendor-react-nSsBnU22.js";import{bI as We,bE as De}from"./vendor-BxYjvUzn.js";import{u as He}from"./index-BcRFd8KM.js";import{p as Re,d as Ce}from"./print-export-DjFgfEmw.js";const we={geometric:{id:"geometric",nameAr:"هندسي",nameEn:"Geometric",description:"هيكل منظم، شبكة، وأرقام مربعة — للرياضيات والفيزياء",headerLayout:"tabular",defaultColor:"#1B2D6B",swatchColors:["#1B2D6B","#E07B20"],css({TC:e,GOLD:s,fontSizePt:r,isAr:o,startSide:i}){return`
    ...
    `})}const Bt=Object.freeze(Object.defineProperty({__proto__:null,WorksheetPrintView:fe,default:st},Symbol.toStringTag,{value:"Module"}));export{we as T,fe as W,At as a,Mt as g,zt as s,Bt as w};
