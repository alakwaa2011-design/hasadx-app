export declare const multiplicationScoresTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "multiplication_scores";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "multiplication_scores";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=multiply-scores.d.ts.map