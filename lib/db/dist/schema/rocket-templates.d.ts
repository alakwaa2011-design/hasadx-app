export declare const rocketTemplatesTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "rocket_templates";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "rocket_templates";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=rocket-templates.d.ts.map